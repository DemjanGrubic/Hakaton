...
namespace Hackathon
{
    ...
    {
        private const string ServerHttpGetRequestFutureLectures = "http://www.caojasamgagi.netne.net/PHP_HACKATHON/get_future_lectures.php";
        private const string ServerHttpGetRequestFutureProblems = "http://www.caojasamgagi.netne.net/PHP_HACKATHON/get_future_problems.php";
        private const string SuccessMessage = "Success";

        private const string getRequestApplyForLecture = "applyForLecture";
        private const string getHttpRequestApplyForLectureUrl = "http://www.caojasamgagi.netne.net/PHP_HACKATHON/add_participation.php?";

        private const string getRequsetSolveProblem = "solveProblem";
        private const string getHttpRequestSolveProblemUrl = "http://www.caojasamgagi.netne.net/PHP_HACKATHON/add_solver.php?";
